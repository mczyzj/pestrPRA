...
if (knitr::is_html_output()) {
 ...
 niepewnosc_oceny      <- c('Niskia/Średnia/Wysokia')
 ...
 cat('<p><b>Obszar PRA: </b>',  obszar_PRA, '</p><p><b>Opis obszaru zagrożenia: </b>', obszar_zagrozenia, '</p><p><b>Główne wnioski:</b><br>', glowne_wnioski, '</p><p><b>Ogólna ocena ryzyka: </b><span style="background-color: #ff6347;">', ryzyko_ogolem, '</span></p><p><b>Środki fitosanitarne: </b>', srodki_fitosanitarne, '</p>', '<div class="rating-box"><div class="top">Ryzyko fitosanitarne dla zagrożonego obszaru</div><div class="center">', ryzyko_fitosanitarne,'</div></div><div class="rating-box"><div class="top">Poziom niepewności oceny</div><div class="center">', niepewnosc_oceny, '</div></div><br>
